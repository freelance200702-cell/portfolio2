...
export const ArchitecturalStructure: React.FC<BaseLandmarkProps> = ({
  ...
  return (
    <group position={[0, 0, 0]}>
      {/* 1. Stepped Concrete Podium Platform */}
      ...
      {/* Recessed Floor Optical Accent Border */}
      ...
      {/* 2. Rear Structural Spine & Shear Wall */}
      ...
      {/* 3. Cantilevered Precast Roof Canopy */}
      ...
      {/* 4. Structural Steel Fins / Columns */}
